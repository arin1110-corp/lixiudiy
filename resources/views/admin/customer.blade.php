                        ...
                        <table id="tabelBidang" class="table table-striped table-bordered w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($b->customer_tanggaldaftar)->translatedFormat('d F Y') }}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-warning btnEdit" data-id="{{ $b->customer_id }}"
                                            data-nama="{{ $b->customer_nama }}" data-produk="{{ $b->customer_telepon }}"
                                            ...
                                            data-alamat="{{ $b->customer_alamat }}"> Lihat Data </button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
            ...
            <form id="formEdit" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEditLabel">Lihat Data Customer</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="edit_email" class="form-label">Email Customer</label>
                            <input type="email" class="form-control" id="edit_email" name="email" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="edit_notelp" class="form-label">No Telepon Customer</label>
                            <input type="text" class="form-control" id="edit_notelp" name="notelp" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="edit_tgllahir" class="form-label">Tanggal Lahir Customer</label>
                            <input type="date" class="form-control" id="edit_tgllahir" name="tgllahir" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="edit_alamat" class="form-label">Alamat Customer</label>
                            <textarea class="form-control" id="edit_alamat" name="alamat" rows="3" readonly></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="edit_tanggalmasuk" class="form-label">Tanggal Daftar Customer</label>
                            <input type="date" class="form-control" id="edit_tanggalmasuk" name="tanggalmasuk" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="edit_status" class="form-label">Status Customer</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btnEdit').click(function() {
                ...
                $('#formEdit').attr('action', '/admin/customer/update/' + id);
                $('#edit_nama').val(nama);
