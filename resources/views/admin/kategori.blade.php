                        ...
                        <table id="tabelBidang" class="table table-striped table-bordered w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-warning btnEdit" data-id="{{ $b->kategori_id }}"
                                            data-nama="{{ $b->kategori_nama }}" data-status="{{ $b->kategori_status }}"
                                            data-deskripsi="{{ $b->kategori_deskripsi }}"
                                            data-gambar="{{ $b->kategori_gambar }}">
                                            Edit
                                        </button>
                                        <button class="btn btn-sm btn-danger btnHapus" data-id="{{ $b->kategori_id }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="kategori_deskripsi" rows="3"></textarea>
                        </div>
                        <div class="mb-3">
                            <label>Gambar</label>
                            <input type="file" class="form-control" name="kategori_gambar" accept="image/*">
                        </div>
                        <div class="mb-3">
                            <label>Status</label>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form id="formEdit" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEditLabel">Edit Data Kategori</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label>Nama Kategori</label>
                            <input type="text" class="form-control" id="edit_nama" name="kategori_nama" required>
                        </div>
                        <div class="mb-3">
                            <label>Deskripsi</label>
                            <textarea class="form-control" name="kategori_deskripsi" rows="3"></textarea>
                        ...
                        <div class="mb-3">
                            <label for="kategori_gambar" class="form-label">Gambar Kategori</label><br>
                            <img id="previewGambar" src="" alt="Preview Gambar" class="img-thumbnail mb-2"
                                style="max-height: 150px;">
                            <input type="file" class="form-control" name="kategori_gambar" id="kategori_gambar">
                        </div>
                        <div class="mb-3">
                            <label>Status</label>
                            <select class="form-select" id="edit_status" name="kategori_status" required>
                                <option value="1">Aktif</option>
                                <option value="0">Tidak Aktif</option>
                            </select>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btnEdit').click(function() {
                ...
                $('#formEdit').attr('action', '/admin/kategori/update/' + id);

                // isi deskripsi
                $('#formEdit textarea[name="kategori_deskripsi"]').val(deskripsi);
            ...
            $('.btnHapus').click(function() {
                ...
                $('#formHapus').attr('action', '/admin/kategori/delete/' + id);
