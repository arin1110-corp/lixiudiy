                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-warning btnEdit" data-id="{{ $b->produk_id }}"
                                                ...
                                                data-gambar="{{ $b->produk_gambar }}"
                                                data-harga="{{ $b->produk_harga }}" data-stok="{{ $b->produk_stok }}"
                                                data-kategori="{{ $b->produk_kategori }}"
            ...
            <form id="formEdit" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Deskripsi</label>
                            <textarea class="form-control" name="produk_deskripsi" id="edit_deskripsi" rows="3"></textarea>
                        </div>
                        <div class="mb-3">
                            <label>Harga</label>
                        ...
                        <div class="mb-3">
                            <label>Tanggal Masuk</label>
                            <input type="date" class="form-control" name="produk_tanggalmasuk"
                                id="edit_tanggalmasuk" required />
                        </div>
                        <div class="mb-3">
                            <label>Gambar Lama</label><br />
                            <img id="previewGambar" src="/images/no-image.png" alt=""
                                width="100" /><br /><br />
