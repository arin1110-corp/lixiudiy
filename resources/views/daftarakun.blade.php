        ...
        <div class="card p-4 p-md-5" style="max-width: 450px; width: 100%;">
            ...
            <form method="POST" action="{{ route('customer.register.submit') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="customer_nama"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="phone" name="customer_telepon"
                        placeholder="08xxxxxxxxxx" required>
                </div>

                <div class="mb-3">
                    <label for="address" class="form-label fw-bold">Alamat</label>
                    <input type="text" class="form-control" id="address" name="customer_alamat"
                        placeholder="Masukkan alamat lengkap" required>
                </div>

                <div class="mb-3">
                    <label for="birthdate" class="form-label fw-bold">Tanggal Lahir</label>
                    <input type="date" class="form-control" id="birthdate" name="customer_tanggallahir" required>
                </div>
